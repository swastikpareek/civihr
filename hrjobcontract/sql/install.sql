...
CREATE TABLE IF NOT EXISTS `civicrm_hrjobcontract` (
    ...
    CONSTRAINT `FK_civicrm_hrjobcontract_contact_id`  FOREIGN KEY (`contact_id`)  REFERENCES `civicrm_contact` (`id`)  ON DELETE CASCADE  ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `civicrm_hrjobcontract_revision` (
    ...
    CONSTRAINT `FK_civicrm_hrjobcontract_revision_jobcontract_id` FOREIGN KEY (`jobcontract_id`) REFERENCES `civicrm_hrjobcontract` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `civicrm_hrjobcontract_details` (
    ...
    CONSTRAINT `FK_civicrm_hrjobcontract_details_contract_revision_id` FOREIGN KEY (`jobcontract_revision_id`) REFERENCES `civicrm_hrjobcontract_revision` (`details_revision_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `civicrm_hrjobcontract_pay` (
    ...
    CONSTRAINT `FK_civicrm_hrjobcontract_pay_jobcontract_revision_id`  FOREIGN KEY (`jobcontract_revision_id`)  REFERENCES `civicrm_hrjobcontract_revision` (`pay_revision_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `civicrm_hrjobcontract_health` (
    ...
    CONSTRAINT `FK_civicrm_hrjobcontract_health_jobcontract_revision_id` FOREIGN KEY (`jobcontract_revision_id`)  REFERENCES `civicrm_hrjobcontract_revision` (`health_revision_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `civicrm_hrjobcontract_hour` (
    ...
    INDEX `index_jobcontract_revision_id` (jobcontract_revision_id ASC),
    CONSTRAINT `FK_civicrm_hrjobcontract_hour_jobcontract_revision_id` FOREIGN KEY (`jobcontract_revision_id`)  REFERENCES `civicrm_hrjobcontract_revision` (`hour_revision_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `civicrm_hrjobcontract_leave` (
    ...
    PRIMARY KEY ( `id` ),
    INDEX `index_jobcontract_revision_id` (jobcontract_revision_id ASC),
    CONSTRAINT `FK_civicrm_hrjobcontract_leave_jobcontract_revision_id`  FOREIGN KEY (`jobcontract_revision_id`)  REFERENCES `civicrm_hrjobcontract_revision` (`leave_revision_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `civicrm_hrjobcontract_pension` (
    ...
    INDEX `index_jobcontract_revision_id` (jobcontract_revision_id ASC),
    CONSTRAINT `FK_civicrm_hrjobcontract_pension_jobcontract_revision_id`  FOREIGN KEY (`jobcontract_revision_id`)  REFERENCES `civicrm_hrjobcontract_revision` (`pension_revision_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `civicrm_hrjobcontract_role` (
    ...
    CONSTRAINT `FK_civicrm_hrjobcontract_role_jobcontract_revision_id`  FOREIGN KEY (`jobcontract_revision_id`)  REFERENCES `civicrm_hrjobcontract_revision` (`role_revision_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
